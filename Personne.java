/**
 * TP Programmation orientéé objet POO1 Création d'une classe personne :
 * Attributs de personne : prenon nom age adresse femme ? Comportements de
 * personne : une personne décline son identité une personne fête son
 * anniversaire une personne déménage Règles de Gestion : changement de sexe
 * direct changement de prenom direct changement d'adresse direct changement de
 * nom indirect changement d'âge indirect
 */
...
public class Personne {
	...
	public void Demenage(Adresse nvlleadresse) {
		System.out.println("déménagement de" + prenom + "vers" + nvlleadresse);
